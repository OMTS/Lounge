#
# Be sure to run `pod lib lint Lounge.podspec' to ensure this is a
...
Lounge help you make chat screen by providing functionnalities common to all chats displaying messages, browse chat history, interactive keyboard with input field, send button etc.
  ...
  s.homepage         = "https://github.com/OMTS/Lounge"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Ysix" => "y-6@hotmail.fr" }
  s.source           = { :git => "https://github.com/OMTS/Lounge.git", :tag => s.version.to_s }
